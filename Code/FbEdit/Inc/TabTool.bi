...
Declare Sub AddTab (ByVal hEdt As HWND, ByRef lpFileName As ZString, ByVal AddMode As AddTabMode)        'MOD2.2.2012    AddTab(ByVal hEdt As HWND,ByVal lpFileName As String,ByVal fHex As WINBOOLEAN)
Declare Sub NextTab (ByVal fPrev As WINBOOLEAN)
Declare Function ShowTab (ByRef FileSpec As ZString) As WINBOOLEAN
...
Declare Function SaveAllTabs () As BOOL                               ' MOD 2.1.2012   (ByVal hWin As HWND)
Declare Function SaveTabAs() As WINBOOLEAN                               ' MOD 1.2.2012    SaveFileAs(ByVal hWin As HWND) As WINBOOLEAN
...
Declare Sub OpenAFile (ByVal OpenMode As FileOpenMode)                ' MOD 1.2.2012 OpenAFile(ByVal hWin As HWND,ByVal fHex As WINBOOLEAN)
Declare Sub OpenAProject ()                                           ' MOD 1.2.2012    OpenAProject(ByVal hWin As HWND) As WINBOOLEAN
...
Declare Function GetEditWindowBySpec (Byref fn As ZString) As HWND          ' MOD 1.2.2012   (ByVal hWin As HWND,ByVal fn As String,ByVal fShow As WINBOOLEAN) As HWND
